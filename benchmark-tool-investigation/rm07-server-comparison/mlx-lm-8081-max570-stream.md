To find the average speed for the entire round trip, we must use the formula:
...
$$ v_{avg} = \frac{2 v_1 v_2}{v_1 + v_2} = \frac{2 \times 60 \times 40}{60 + 40} = \frac{4800}{100} = 48 \, \text{km/h} $$